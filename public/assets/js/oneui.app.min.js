    ...
    class pr {
        ...
        static jqMaskedInputs() {
            jQuery(".js-masked-date:not(.js-masked-enabled)").mask("99/99/9999"),
                ...
                jQuery(".js-masked-phone-rus:not(.js-masked-enabled)").mask("9 (999) 999-9999"),
                ...
                jQuery(".js-masked-passport-series:not(.js-masked-enabled)").mask("9999"),
                jQuery(".js-masked-passport-number:not(.js-masked-enabled)").mask("999999"),
                jQuery(".js-masked-date").add("js-masked-passport-series").add("js-masked-passport-number").add("js-masked-phone-rus").add(".js-masked-date-dash").add(".js-masked-phone").add(".js-masked-phone-ext").add(".js-masked-taxid").add(".js-masked-ssn").add(".js-masked-snils").add(".js-masked-pkey").add(".js-masked-time").addClass("js-masked-enabled")
        }
