...
export default class extends Controller {
    ...
    studentGroupSelect;
    connect() {
        let contingent_document_form_id=$("#contingent_document_form_id").val();
        console.log(contingent_document_form_id);
        console.log('ecdsidc')
        let select;
        ...
        this.getStudentGroupList().then(data => {
            ...
            ajax: {
                url: '/api/contingent_documents/'+contingent_document_form_id,
