...
use App\mod_admission\Form\AbiturientPetitionLoadType;
use App\mod_admission\Form\AbiturientPetitionType;
...
use App\mod_education\Repository\PersonalDocumentsRepository;
...
class AbiturientPetitionController extends AbstractController
{
    ...
    public function connect_student_persona(AbiturientPetitionRepository $abiturientPetitionRepository): Response
    {
        ...
        foreach ($abiturientPetitionRepository->findAll() as $item) {
            /***
             * @var \App\mod_admission\Entity\AbiturientPetition $item
             */
     ...
     * @param Request $request
     * @param \App\mod_admission\Entity\AbiturientPetition $abiturientPetition
     * @param \App\mod_admission\Repository\AbiturientPetitionRepository $abiturientPetitionRepository
     * @param PetitionLoadService $petitionLoadService
     * @return Response
     */
    ...
    public function showByAdmissionPlanAndExamResutl(Request $request): Response
    {
         ...
         * @var \App\mod_admission\Entity\Admission $admission
         * @var \App\mod_education\Entity\Faculty $facultyID
