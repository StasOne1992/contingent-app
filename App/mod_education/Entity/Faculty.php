...
use App\mod_admission\Entity\AdmissionExamination;
...
class Faculty
{
    ...
    #[ORM\OneToMany(mappedBy: 'Faculty', targetEntity: \App\mod_admission\Entity\AbiturientPetition::class)]
    ...
    /**
     * @return Collection<int, \App\mod_admission\Entity\AbiturientPetition>
     */
    ...
    public function removeAbiturientPetition(\App\mod_admission\Entity\AbiturientPetition $abiturientPetition): static
    {
